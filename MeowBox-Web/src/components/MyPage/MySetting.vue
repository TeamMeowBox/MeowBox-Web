<template>
  <v-expansion-panel class="setting-container">
    <v-expansion-panel-content
      expand-icon="fas fa-caret-down"
    >
      <div slot="header">공지사항</div>
      <v-card>
        <v-card-text class="settind-contents">
          <div class="7-14-notice-1">
            <h3>드디어 미유박스가 출시되었습니다!</h3>
            <small>2018/ 07/ 14</small>
            <p>안녕하세요, 미유박스 운영팀입니다. <br><br>
            드디어 기다리고 기다리던 미유박스가 출시되었습니다.<br><br>
            미유박스는 반려묘를 키우는 미유팀이 직접 반려묘를 키우면서 경험한 것을 녹여서 만든 서비스입니다.<br>
            아이들의 정보를 바탕으로 맞춤형 놀이, 음식을 보내드립니다.<br>
            기대되시죠!?<br><br>
            냥이들을 위한 다양한 이벤트와 행사를 준비하였으니,<br>
            많은 관심과 애정! 부탁드리겠습니다.<br><br>
            반려묘에게 아낌없는 사랑을 주고 싶은 Meow Box가 되겠습니다.<br>
            미유박스 운영팀 드림.</p>
          </div>
          <br>
          <hr>
          <br>
          <div class="7-14-notice-2">
            <h3>미유박스 주문관련 공지입니다.</h3>
            <small>2018/ 07/ 14</small>
            <p>안녕하세요, 미유님들!<br><br>
            주문해주신 미유박스를 취소/반품/환불 요청은 홈페이지 고객센터 1:1 문의에 접수해주시면 감사하겠습니다.<br>
            다만, 주문취소(결제취소)의 경우 결제일로부터 매주 월요일 이전까지 가능합니다.<br>
            월요일 당일 오전 10시 이후 주문, 결제건은 배송처리를 위해 배송정보 출력 및 포장/배송진행을 위한 작업을 바로 진행하기 때문에<br>
            취소처리가 어려운점 양해해주시면 감사하겠습니다.<br><br>
            어려움이 있으실 경우, 고객센터로 연락주시면 자세하게 상담드리도록 하겠습니다.<br><br>
            미유박스 운영팀 드림.</p>
          </div>
        </v-card-text>
      </v-card>
    ...
    <v-expansion-panel-content
      expand-icon="fas fa-caret-down"
    >
      <div slot="header">이용약관</div>
      <v-card>
        <v-card-text class="settind-contents">
          <p>제1조 목적<br><br>
          본 이용약관은 “미유박스”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.<br><br>
          ...
          - 기타 관계법령에 위배된다고 판단되는 경우4. 사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시중단(전송중단)할 수 있으며, 게시중단 요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련기관의 결정 등이 이루어져 사이트에 접수된 경우 이에 따릅니다.<br><br>

          제13조 게시물의 보관<br><br>

          사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우, 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 취하기 위해 노력합니다.<br><br>
          ...
          ③ 운영자는 회원이 게시하거나 등록하는 사이트 내의 내용물, 게시 내용에 대해 제12조 각 호에 해당된다고 판단되는 경우 사전통지 없이 삭제하거나 이동 또는 등록 거부할 수 있습니다.<br><br>
    ...
    <v-expansion-panel-content
      expand-icon="fas fa-caret-down"
    >
      <div slot="header">개인정보 취급 방침</div>
      <v-card>
        <v-card-text class="settind-contents">
          <p>1. 개인정보의 처리 목적 &lt;미유박스&gt;(이하 ‘사이트’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.<br>
          - 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등<br><br><br>


          2. 개인정보처리 위탁<br><br>

          ① 사이트는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br><br>

          ② 사이트는 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br><br>

          ③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.<br><br><br>


          3. 정보주체의 권리,의무 및 그 행사방법 이용자는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.<br><br>
          ...
          4. 처리하는 개인정보의 항목 작성<br><br>

          ① 사이트는 다음의 개인정보 항목을 처리하고 있습니다.<br><br>

          - 필수항목 : 비밀번호, 로그인ID, 이메일, 접속 IP 정보, 쿠키, 접속 로그<br>
          - 선택항목 : 생년월일, 자택전화번호, 휴대전화번호, 이름 등<br><br><br>


          5. 개인정보의 파기<br><br>

          사이트는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br><br>
          ...
          6. 개인정보의 안전성 확보 조치<br><br>

          사이트는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br><br>
          ...
          사이트는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.<br><br><br>


          7. 개인정보 보호책임자 작성<br><br><br>


          ① 사이트는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br><br>

          ▶ 개인정보 보호책임자<br>
          성명 : 이시형<br>
          직책 : 운영팀 <br>
          직급 : 팀장<br>
          연락처 : 010-5195-2720<br><br>

          ② 정보주체께서는 사이트의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 사이트는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br><br><br>


          8. 개인정보 처리방침 변경<br><br>

          ① 이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.<br></p>
        </v-card-text>
      </v-card>
    </v-expansion-panel-content>
  </v-expansion-panel>
...
<style lang="scss">
  @import '../../assets/scss/MySetting.scss';
</style>
