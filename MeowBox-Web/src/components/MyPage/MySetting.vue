<template>
  <v-expansion-panel>
    <v-extension-panel-content>
        <div>
            알림설정
            <v-btn style="width:20vw; background:#e68789; color:white">ON</v-btn>
            <v-btn style="width:20vw; background:#e68789; color:white">OFF</v-btn>
        </div>
    </v-extension-panel-content>
